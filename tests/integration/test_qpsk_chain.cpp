...
TEST_F(QpskChainTest, PerfectChannelYieldsZeroBer) {
...
TEST_F(QpskChainTest, BerDecreasesAsSnrIncreases) {
...
TEST_F(QpskChainTest, BerAt10dBCoherentWithTheory) {
...
TEST_F(QpskChainTest, BerAt0dBAroundExpectedValue) {
...
TEST_F(QpskChainTest, Sent8BitsEqualReceivedBitsOnPerfectChannel) {
    AwgnChannel channel(100.0, 42);
...
TEST_F(QpskChainTest, Sent100000BitsEqualReceivedBitsOnPerfectChannel) {
    AwgnChannel channel(100.0, 42);
